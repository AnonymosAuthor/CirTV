...
# 设置 f_a 和 f_b 的约束
s.add(f_b == a % p)
s.add(f_a == SignExt(224, b) % p)

# a<0
#action1 = r_temp * R % p == Extract(255, 0, ZeroExt(256, f_b) * ZeroExt(256, f_a) % ZeroExt(256, p))
# a>=0
#action2 = r_temp * R % p == Extract(255, 0, ZeroExt(256, f_b) * ZeroExt(256, f_a) % ZeroExt(256, p))
